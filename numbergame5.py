...
def checkPlayerIsOnTheColorBox():
    ...
    if (player_1_f_move == player_1_f_steps) and ((player_pos[0][0] == 225 and player_pos[0][1] == 475) or (player_pos[0][0] == 475 and player_pos[0][1] == 375) or (player_pos[0][0] == 125 and player_pos[0][1] == 275) or (player_pos[0][0] == 375 and player_pos[0][1] == 175) or (player_pos[0][0] == 175 and player_pos[0][1] == 75)):
    ...
    elif (player_2_f_move == player_2_f_steps) and ((player_pos[1][0] == 225 and player_pos[1][1] == 475) or (player_pos[1][0] == 475 and player_pos[1][1] == 375) or (player_pos[1][0] == 125 and player_pos[1][1] == 275) or (player_pos[1][0] == 375 and player_pos[1][1] == 175) or (player_pos[1][0] == 175 and player_pos[1][1] == 75)):
